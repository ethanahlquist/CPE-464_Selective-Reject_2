...
//enum FLAG
//{
//FNAME = 7, DATA = 3, FNAME_OK = 8, FNAME_BAD = 9, ACK = 5, END_OF_FILE = 10, EOF_ACK = 11, CRC_ERROR = -145 };

enum FLAG
{
FNAME = 7, DATA = 3, FNAME_OK = 8, FNAME_BAD = 9, RR = 5, ACK = 5, SREJ = 6, END_OF_FILE = 10, EOF_ACK = 11, CRC_ERROR = -145 };
